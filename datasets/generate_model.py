...
from models_rad.cnn import cnn3d
from models_rad import (cnn, C3DNet, resnet, ResNetV2, ResNeXt, ResNeXtV2, WideResNet, PreActResNet,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_classes', default=4, type=str, help='model output classes')
    parser.add_argument('--in_channels', default=1, type=str, help='model input channels (1|3)')
    parser.add_argument('--sample_size', default=256, type=str, help='image size')
    ...
    # 保存整个模型
    torch.save(model, '/home/yanyiqun/MCAT/datasets/rad.pth')
    print(model)
...
from SAMMed3D.segment_anything.modeling import ImageEncoderViT3D, MaskDecoder3D, PromptEncoder3D, Sam3D
...
def _build_sam3D(
    ...
    if checkpoint is not None:
        with open(checkpoint, "rb") as f:
            ...
            # 假设你只想保留与 image_encoder 相关的权重
            partial_state_dict = {k: v for k, v in model_state_dict.items() if 'image_encoder' in k}

        sam.load_state_dict(partial_state_dict)
    return sam
